...
export default function AdminPanel() {
  ...
  const loadViewStats = () => {
    try {
      ...
      if (stored) {
        ...
        const recent = stats.sort((a, b) => b.date.localeCompare(a.date)).slice(0, 7);
        setViewStats(recent);
      }
    } catch (error) {
  ...
  return (
    <>
      ...
      {/* Admin Panel */}
      {isVisible && (
        <div className="fixed bottom-16 right-4 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-50 w-64">
          ...
          {/* Daily Views */}
          <div className="mb-4">
            <h4 className="text-sm font-medium text-gray-700 mb-2">Daily Views (Last 7 days)</h4>

    ...
    <div className="p-4 sm:p-6 bg-gray-50 rounded-lg space-y-4 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <DistributionChart
          ...
          sampleLineLabel={showResults ? "\\frac{p_{\\text{peaky}}(x)}{p_{\\text{broad}}(x)} \\text{ is moderate}" : undefined}
          isPeakyTrue={true}
        />
        ...
        <DistributionChart
          ...
          sampleLineLabel={showResults ? "\\frac{p_{\\text{broad}}(x)}{p_{\\text{peaky}}(x)} \\text{ is large}" : undefined}
          isPeakyTrue={false}
        />
      </div>

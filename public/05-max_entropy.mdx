...
In the [previous chapter](03-minimizing), we saw how minimizing KL divergence generalizes two important statistical concepts: **maximum likelihood** and **maximum entropy**.
...
![conditioning](04-mle/condition.png)
...
![syntax-error](04-mle/syntax_error.png)
...
![max-ent](04-mle/max_ent_example.png)
...
As we'll discuss [later](07-machine_learning), this particular distribution $p$ turns out to be the Gaussian with mean $\mu$ and variance $\sigma^2$. So, the maximum entropy principle tells us that, without additional evidence, we should model such data as Gaussian, assuming the given mean and variance.
...
![potato](04-mle/potato_maxent.png)

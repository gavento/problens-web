...
These are all amazing [open exposition problems](https://mathoverflow.net/questions/281852/important-open-exposition-problems)! And 2025 may well be the last year before getting dominated by AIs so we want to do this sooner rather than later!

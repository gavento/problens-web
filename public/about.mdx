...
The total length of the main text is about ?? chapters of Harry Potter and the Philosopher's stone (From the beginning to when Harry ??). ?? chapters if you read all footnotes and Expanding boxes (Harry ??)

...
Our Laplace story suggests that the data should look more like Gaussian at the beginning and then look more and more like Laplace, which seems to be happening. 

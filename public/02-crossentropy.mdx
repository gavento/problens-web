...
<Example headline = "Example: Entropy of 4 common English words">
Here's an example. Let's say there are about $2^{11}$ English words that can be described as 'common'. If you generate uniformly four such common words and make your password the concatenation of them, the total entropy is thus going to be $44$ bits. That's because entropy is a special case of cross-entropy and is thus additive. 

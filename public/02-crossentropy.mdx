...
KL divergence and entropy are closely connected to coding theory. There are [many amazing explainers of that](resources), so let's only see a quick intuition for why this is so closely connected.  

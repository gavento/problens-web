...
<dl>
    ...
    The entropy can get much smaller -- for example,<Math math = "H(\{\textrm{H: }0.001, \textrm{T: }0.999\}) = 0.01" />. That makes sense, there is not much average surprise if we keep flipping this coin! The entropy can go down all the way to zero, if the distribution has 100\% chance of giving one outcome. 

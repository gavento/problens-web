...
We have used this property implicitly in the previous chapter -- it allowed us to compute the overall KL divergence as the sum for individual flips. 

<Expand headline="Proof of additivity">
The fact can be verified by writing down the definitions. Here it is (by Claude):

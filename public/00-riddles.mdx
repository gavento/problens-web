...
1. First, we will understand how Bayes' rule leads to the KL divergence, cross-entropy and entropy (first three chapters). 
...
3. Finally, we will discuss how entropy is related to coding theory, and what kind of intuition it gives us about large language models (final two chapters). 
...
<p className="text-center text-sm italic font-medium text-gray-700 max-w-2xl mx-auto mt-0 px-2">
  I am very upset that in Matrix, it's the red pill that represents the “truth”.  We will talk a lot about the
  <em>true distribution</em> and <em>its model</em>, with the opposite color-coding.
</p>

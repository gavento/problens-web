...
<MultipleChoiceQuestion
  ...
  correctIndices={[1, 2]}
  explanation={<>We'll use KL divergence to derive something called the <a href="04-max_entropy">maximum entropy principle</a> that explains why our gut feeling says we are not necessarily fine here.</>}
/> 
</Expand>

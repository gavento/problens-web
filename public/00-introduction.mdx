...
This was a trick question because both answers 1 & 2 are kind of true for both S&P and Bitcoin! The shape of the histogram depends on something I did not tell you -- how far in the past did I look to collect the data. Try it for yourself both for S&P and Bitcoin:
...
[We will use KL divergence](04-max_entropy/application-understanding-financial-data) to understand a deep principle in probability called maximum entropy principle. This will give us a lot of intuition for what both normal and Laplace distributions stand for.
</Expand>
...
In [the next part](01-kl_intro), we'll define KL divergence and understand what it stands for. 

...
<MultipleChoiceQuestion
  ...
  What's happening here? We will discuss this example in the <a href="05-max_entropy">chapter about the max-entropy principle</a>. This principle is extremely useful in situations like ours, when we want to model some kind of data. <br/><br/></>}
/>

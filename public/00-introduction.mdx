...
<Expand headline="How to get rich"> <a id="financial-mathematics"></a>
...
We will use KL divergence to understand a deep principle in probability called maximum entropy principle. This will help us gain a lot of intuition for what both normal and Laplace distributions stand for.
</Expand>

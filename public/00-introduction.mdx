...
This web contains an introduction to various topics at the intersection of probability, information theory, and machine learning. Our guide through this world is a formula called _Kullback-Leibler (KL) divergence_. 

Check out [this page](about) for logistics. Here, we've got several riddles some of which will hopefully [nerd-snipe](https://xkcd.com/356/) you! The goal is that you understand all of them at the end of the minicourse!
...
As we go through this mini-course, we'll use KL divergence to revisit each puzzle and understand what's going on. 

The mini-course has five chapters. Here's what they cover. 

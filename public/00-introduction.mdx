...
Where the hell are all these, so-called "loss functions", coming from?? [We'll see](06-machine_learning) how KL divergence and entropy make sense of this mess—and tons of other standard ML algorithms too, like those in the widget below. 

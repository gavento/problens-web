...
Trick question—both B and C kind of work! The shape totally depends on something I didn't tell you: how far back I looked. If you only check the last month, shape C fits better. But zoom out to longer periods and it starts looking like B. What's up with that? We will see in the [chapter about the max-entropy principle](04-max_entropy/financial). 

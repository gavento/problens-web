...
<MultipleChoiceQuestion
  ...
  correctIndices={[0, 1, 2]}
  feedbackType="all-show"
  explanation={<>Hard to tell with just 5 questions. But I am not a big fan of 🧑🏻 though, with his failed 99%-confidence prediction! Later, we'll see how KL divergence gives us the log-score that forecasting tournaments use; this score penalizes failed 99%-confidence predictions quite heavily!   
  <ExpertRatingWidget
    title="Log score"
...
Here's a riddle that's behind a ton of recent algorithms in CS and ML. Say you wanna get rich trading stocks. Lucky you—$n$ investors share their tips every day. Each day $t$, they give advice, and afterward you find out how they did. For investor $i$, you get her loss $\ell_i^{(t)}$.<Footnote>Positive loss means bad advice, negative loss means good advice.</Footnote>

...
<MultipleChoiceQuestion
  ...
  What's happening here? We will discuss this example in the <a href="04-max_entropy">chapter about the max-entropy principle</a>. This principle is extremely useful in situations like ours, when you want to model some kind of data. <br/><br/></>}
/>

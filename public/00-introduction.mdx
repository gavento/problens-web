...
## The Power of KL Divergence <a id="preview-the-power-of-kl-divergence"></a>
...
In the next part, we'll define KL divergence and understand what it stands for. Ready to begin? Let's start with [Quantifying Information](/01-quantifying).

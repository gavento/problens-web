...
<MultipleChoiceQuestion
  ...
  explanation={<>Trick question—both shapes B (Laplace distribution) and C (Gaussian distribution) kind of work! The shape totally depends on something I didn't tell you: how far back I looked. If you only check the last month, shape C fits better (though in that case it's hard to judge). But zoom out to longer periods and it starts looking more like B. What's up with that? We will see in the <a href="04-max_entropy/financial">chapter about the max-entropy principle</a>.<br/><br/><FinanceImageSliderWidget /></>}
/>
...
Question is: which expert is the best one?
...
<MultipleChoiceQuestion
  ...
  correctIndices={[1, 2]}
  explanation={<>We'll use KL divergence to derive something called the <a href="04-max_entropy/xkcd">maximum entropy principle</a> that explains why our gut feeling says we are not necessarily fine here.</>}
/> 
</Expand>

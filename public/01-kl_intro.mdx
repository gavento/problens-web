...
<div className="math-display-large">
<Math displayMode={true} math='\underbrace{0.25}_{P(\textsf{H})} \cdot \underbrace{-1 \textrm{ bit}}_{\textrm{evidence when \textsf{H}}} + \underbrace{0.75}_{P(\textsf{T})} \cdot \underbrace{0.58 \textrm{ bits}}_{\textrm{evidence when \textsf{T}}} \approx \underbrace{0.19 \textrm{ bits}}_{\textrm{expected evidence per flip}}' />
</div>

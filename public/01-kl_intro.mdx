...
We'll break this down in the rest of the chapter, bit by bit. 🙂
...
Notice KL divergence is about the evidence, not your starting beliefs. It tells you how fast beliefs change, no matter where you start. Sometimes, we like to divide statistical approaches This makes it work well  Even though we've been all about Bayes' rule here, KL divergence works for both Bayesian and frequentist statistics. 

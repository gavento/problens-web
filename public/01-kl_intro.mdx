...
When you subtract surprisals for the same outcome under different hypotheses, you get how much evidence that outcome provides. For our coin example, heads give you 0.32 bits of evidence for fair, tails give 0.26 bits for biased.
